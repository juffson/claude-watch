 ...
 * Size: 120 px
 * Bpp: 4
 * Opts: --font ../libraries/lvgl/scripts/built_in_font/Montserrat-Medium.ttf -r 0x30-0x3A --size 120 --bpp 4 --format lvgl --no-compress --lv-include lvgl.h -o font_mont_120.c
 ******************************************************************************/
...
#ifndef FONT_MONT_120
#define FONT_MONT_120 1
#endif
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_mont_120 = {
#else
lv_font_t font_mont_120 = {
#endif
